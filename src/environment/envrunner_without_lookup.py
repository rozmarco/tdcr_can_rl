...
class EnvRunner:
    ...
    def __init__(
        ...
        goal_data_path: str = None,        # ← ADD THIS
        ...
        self.env = CustomEnv(scene_path, render_mode, frame_skips, timestep,goal_data_path=goal_data_path)
...
class ParallelEnvRunner(EnvRunner):
    def __init__(self, is_train, scene_path, policy, config):
        super().__init__(
            ...
            goal_data_path=config["env"].get("goal_data_path", None),
            buffer=ReplayBuffer(),                          # ← ADD
            data_dir=str(Path("data").resolve()),           # ← ADD
            seed=config["seed"],
