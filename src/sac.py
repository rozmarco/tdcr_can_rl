...
class SoftActorCritic(nn.Module):
    ...
    def soft_update(self):
        """Gradually shift target weights toward live weights.
    ...
    def update(self):
        ...
        with torch.no_grad():
            next_action, next_log_pi = self.policy.sample(s_next, self.horizon)
        ...
        # --- Soft-update target Q-networks (once per update step) ---
        self.soft_update()